...
if MODE == "train":
    if DATA == "LifeSnaps":
        ...
        DATA_PATH = "/u/ybkim95/medAlpaca/data/life_snaps"
        ...
        DATA_PATH = "/u/ybkim95/medAlpaca/data/harvard_dataverse"
        SUBTASK = "activity"
        ...
        """
        participant_info = {
            'p02': [60, 180, 'M', 'A', 'Academia'],
            'p04': [26, 164, 'F', 'A', 'Industry'],
            'p08': [27, 186, 'M', 'B', 'Industry'],
            'p07': [26, 177, 'M', 'B', 'Industry'],
            'p13': [31, 183, 'M', 'A', 'Industry'],
            'p05': [35, 176, 'M', 'A', 'Academia'],
            'p01': [48, 195, 'M', 'A', 'Academia'],
            'p03': [25, 184, 'M', 'A', 'Academia'],
            'p09': [26, 180, 'M', 'B', 'Academia'],
            'p16': [23, 182, 'M', 'B', 'Industry'],
            'p06': [42, 179, 'M', 'B', 'Industry'],
            'p12': [27, 178, 'M', 'A', 'Industry'],
            'p15': [54, 180, 'M', 'A', 'Industry'],
            'p14': [45, 181, 'M', 'A', 'Industry'],
            'p11': [25, 171, 'F', 'A', 'Industry'],
            'p10': [38, 179, 'F', 'B', 'Academia']
        }
        
        DATA_PATH = "/u/ybkim95/medAlpaca/data/pmdata"
        ...
        for insw_idx in tqdm([1,2,3,4]):
            data1 = csv_reader('/u/ybkim95/medAlpaca/data/globem/INS-W_{}/SurveyData/dep_weekly.csv'.format(insw_idx))
            dict1 = {}
            keys1 = []
            ...
            data2 = csv_reader('/u/ybkim95/medAlpaca/data/globem/INS-W_{}/FeatureData/steps.csv'.format(insw_idx))
            dict2 = {}
            keys2 = []
            ...
            data3 = csv_reader('/u/ybkim95/medAlpaca/data/globem/INS-W_{}/FeatureData/sleep.csv'.format(insw_idx))
            dict3 = {}
            keys3 = []
...
# if MODE == "eval":
#     if DATA == "LifeSnaps":
#         life_snaps_data = json_reader("/u/ybkim95/medAlpaca/data/LifeSnaps.json")
#         eval_data = []
#         no = 1
